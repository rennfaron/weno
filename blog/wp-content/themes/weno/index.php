<?php get_header(); ?>
    <div class="weno-blog-page home bg-jagged br-lightcyan-fill-top">
        <div class="xxxwide clearfix">
            <section class="blog">
                ...
                <article>
                    ...
                    <?php the_content(); ?>
                    <p><?php comments_popup_link('0 Comments', '1 Comment', '% Comments'); ?> | Posted in: <?php $category = get_the_category(); if($category[0]){ echo '<a class="post-category" href="'.get_category_link($category[0]->term_id ).'">'.$category[0]->cat_name.'.</a>'; } ?></p>
                </article>
                <?php
                endwhile;
